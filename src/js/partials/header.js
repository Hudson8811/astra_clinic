...
function initLessFullHdHeaderHandlers() {
	...
	$('.js-open-sub-menu').on('click.lessFullHdHeader', function () {
		...
		subMenus.removeClass('hmm-sub-menu--is-open');
		$(this).siblings('.hmm-sub-menu').addClass('hmm-sub-menu--is-open');
...
function disableMobileHeaderHandlers() {
	$('.sh-burger-wrap').off('.mobileHeader');
	$('.js-open-sub-menu').off('.mobileHeader');
}
...
function clearMenuClasses() {
	...
	subMenus.removeClass('hmm-sub-menu--is-open');
	shBurgerWrap.removeClass('sh-burger-wrap--active');
	hMainMenu.removeClass('header-main-menu--mobile-active').removeClass('header-main-menu--tablet-active').removeClass('header-main-menu--open-sub');
	subMenuTriggers.removeClass('hmm-item__a--active');
}
	...
	if (previousState !== newState) {
		if (previousState) {
			...
			switch (previousState) {
				case 'mobile':
					disableMobileHeaderHandlers();
					break;

				case 'tablet':
					disableLessFullHdHeaderHandlers();
					break;

				case 'desktop':
					disableFullHdHeaderHandlers();
					break;
			}
		}
		switch (newState) {
